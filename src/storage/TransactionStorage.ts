...
export class TransactionStorage implements IStorage<Buffer> {
    private cache: Map<string, TransactionEntry> = new Map();
    ...
    private async compressTransactionLog(force?: boolean): Promise<void> {
        ...
        let compressNow = force || (
            this.entryCount > DEFRAG_ENTRY_THRESHOLD && this.entryCount > this.cache.size * DEFRAG_REDUNDANT_FRACTION_THRESHOLD
