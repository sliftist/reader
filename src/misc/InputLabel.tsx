...
export class InputLabel extends preact.Component<InputLabelProps> {
    ...
    edittingInput: HTMLInputElement | null = null;
    ...
    render() {
        ...
        let stateEditting = this.state.editting;
        if (props.edit && props.placeholder) {
            stateEditting = true;
        }
        let sizeBasedOnContents = props.edit || props.textarea;
        ...
        if (sizeBasedOnContents) {
            ...
            props.onChange = e => {
                this.setState({ editUpdateSeqNum: this.state.editUpdateSeqNum + 1 });
                baseChange?.(e);
            };
            this.state.editUpdateSeqNum;
        }
        ...
        let input = <Input
            ...
            inputRef={(obj: HTMLInputElement | null) => {
                this.edittingInput = obj;
                props.inputRef?.(obj);
            }}
        />;
            ...
            <label onClick={onClick} class={
                ...
                {sizeBasedOnContents &&
                    ...
                    >
                        ...
                        {this.edittingInput?.value || this.edittingInput?.placeholder || props.placeholder} |
                    </span>
                }
                {/* <div
                    class={
